...
| :---                                  | :---                            | :---                                                                                                                                           |
| GV                                    | `@GV(VALUE_ID)`                 | Used to get values. Learn more about *values* [here](../values/).                                                                               |
| GETVALUE *(GV ALIAS)*                 | `@GETVALUE(VALUE_ID)`           | Used to get values. Learn more about *values* [here](../values/).                                                                               |
