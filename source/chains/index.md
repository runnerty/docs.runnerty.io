...
**id**, identifies the chain. with this identifier Runnerty will provide a global value (*CHAIN_ID*) that can be used in the whole chain.
...
### Execution (Triggers)
The way to execute chains is by using [triggers](../triggers/)
